...
$(function () {
    ...
    $("#entry_btn").on("click", function (event) {
        let user = $("#entry_name").val();
        let pw = $("#entry_password").val();
        // let formData = new FormData();
        // formData.append("user", $("#entry_name").val());
        // formData.append("pw", $("#entry_password").val());
        $.ajax({
            url: "/login",
            type: "POST",
            ...
            success: function (data) {
                if (data) {
                    document.cookie = "pic_bed_lg=" + escape(data) + "; path=/";   //转码并赋值
                } else {
                    alert("账号或密码错误！");
                }
            },
